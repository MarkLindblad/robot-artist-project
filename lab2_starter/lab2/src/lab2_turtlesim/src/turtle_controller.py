...
def talker(turtle_name):
    ...
    while not rospy.is_shutdown():
        ...
        user_input = raw_input("Please enter wasd key: ").strip()

        xl, yl, zl, xa, ya, za = 0,0,0,0,0,0
        if user_input == 'w':
            xl = 2
        elif user_input == 'a':
            za = 2
        ...
        pub.publish(Twist(linear=Vector3(x=xl, y=yl, z=zl), angular=Vector3(x=xa, y=ya, z=za)))
